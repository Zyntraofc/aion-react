...
function SignupPage() {
    ...
    return (
        <div className="w-full flex items-center justify-center font-sans">
            <div className="grid grid-cols-5 rounded-3xl shadow-2xl z-10 max-w-4xl w-full mt-30 mb-50 bg-gray-100 p-4 gap-4">
                                ...
                                {step === 1 && (
                                    ...
                                    >
                                        ...
                                        <button
                                            type="button"
                                            onClick={handleNext}
                                            className="w-full py-3 mt-4 mb-6 font-semibold rounded-2xl bg-gradient-to-r from-primary to-tertiary text-white shadow-md"
                                        >
                                            Continuar
                                        </button>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                type="button"
                                                onClick={handleBack}
                                                className="text-gray-500 bg-gray-300 mt-4 mb-6 rounded-2xl shadow-md "
                                            >
                                                Voltar
                                            </button>
                                            <button
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            {[
                                                ...
                                                <div
                                                    key={field.id}
                                                    className={`${field.full ? "col-span-2" : "flex-1"}`}
                                                >
                                                    <div className="flex justify-between items-center">
                                                        <label
                                                            htmlFor={field.id}
